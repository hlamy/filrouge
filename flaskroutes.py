...
def uploadfile():
    ...
    try:
       fichierclient = request.files['file']
        ...
        return {'Error' : 'No file received'}, 412
    ...
    try:
        ...
        return {'Error' : 'File saving problem'}, 507
    ...
    try:
        ...
        return {'Error' : 'File format unsupported, could not extract metadata'}, 415
    ...
    try:
        if metadatafile['generic_given_extension'] == '.csv':
            ...
            metadatafile['generic_broad_type'] = 'chiffres'
    except:
        pass
